// To parse this data:
//
//   import { Convert, APIResult } from "./file";
//
//   const aPIResult = Convert.toAPIResult(json);
//
...
export class Convert {
    public static toAPIResult(json: string): APIResult {
        return cast(JSON.parse(json), r("APIResult"));
    }

    public static aPIResultToJson(value: APIResult): string {
        return JSON.stringify(uncast(value, r("APIResult")), null, 2);
    }
}
